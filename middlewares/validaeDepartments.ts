...
export const validateDepartment = [
    body('name').isString().withMessage("Department name must be string").notEmpty().withMessage("Department name is required").matches(/^[A-Za-z\s]+$/).withMessage("Department must contain only alphabets and spaces"),
